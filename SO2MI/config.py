...
if os.path.isfile("config.ini"):
    ...
    CONFIG["misc"]["EnableAlias"] = strtobool(os.environ.get("EnableAlias", True))
    CONFIG["misc"]["EnableRegularExecution"] = strtobool(os.environ.get("EnableRegularExecution", False))
